-- Migration: Fix place_order_atomic RPC Schema Alignment (Sprint 3.2.1)
-- Description: Align profiles and orders column mappings and enforce temporary shipping rules safely.

BEGIN;

-- Recreate function place_order_atomic with schema alignment fixes
