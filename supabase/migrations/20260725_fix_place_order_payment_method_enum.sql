-- Migration: Fix place_order_atomic payment_method cast (Sprint 3.2.2)
-- Description: Cast p_payment_method input parameter to the custom public.payment_method enum type.
